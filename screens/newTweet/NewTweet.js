...
import TweetHandler from '../../handlers/newPost/newTweet';
...
export default function NewTweet() {
  ...
  return <NewTweetComponente user={user} />;
}

function NewTweetComponente({ user}) {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: 'white' }}>
      <View style={styles.container}>
        ...
        <Text style={styles.tweetPreview}>{tweetPreview}</Text>
        ...
        <Dialog
          ...
          message="Tweet generated successfully" // Puedes personalizar el mensaje aquí
