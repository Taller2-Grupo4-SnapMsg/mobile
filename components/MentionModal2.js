...
import UserSearchForMentionFlatList2 from './UserSearchForMentionFlatList2';
...
export default function MentionModal2({ isVisible, onClose, setSelectedMentions, selectedMentions, in_followers }) {
